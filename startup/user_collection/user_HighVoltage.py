...
class Sample(SampleTSAXS):
    ...
    def __init__(self, name, base=None, **md):
        ...
        self._axes["x"].origin = -26.4
        self._axes["y"].origin = 18.5
...
sam = '5248QSA_insitu_polling_real'
thickness = 25um

12V DC input = 6kV DC output (0.7V cutoff)

1V input = 500V output

The questions is how to measure the breakthrough inside the vacuum. 


sam = 'terP_qsa60_insitu_polling'

the sample doesnot show structural variaion, but after 100MV, the breakthrough is clearly shown as a vertical line. 

sam=Sample('terP_qsa60_after100MV')
the sample is rotated 90deg and sent back to search the breakthru area.  
y=-0.8 has less intensity/background than others. It is possibly the breakthrough point, however, there is still no structure change. 
"""
